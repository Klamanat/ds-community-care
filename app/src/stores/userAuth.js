...
export const useUserAuthStore = defineStore('userAuth', () => {
  ...
  function logout() {
    ...
    ;['user_id','user_name','user_role','user_imgid','user_img','user_dept','dsc_ann_seen'].forEach(k => localStorage.removeItem(k))
  }

  return { userId, userName, userRole, userImgId, userImgUrl, userDept, isLoading, error, isAuthenticated, loginWithEmployee, logout }
})
